export const datas = [
	...
	},
	{
		...
		title: 'Cat to home',
		labels: {
			name: ['API REST Wordpress', 'Vue.js'],
		},
	...
	{
		picture: {
			src: require('@/assets/images/capture_gestion_absences.png'),
			alt: "Capture d'écran de l'application de gestion d'absences",
		},
		...
		links: [
			...
			{
				link: 'https://github.com/Damien-LAITANI/Gestion_absences_React_Node',
				name: 'Github',
			},
		],
	},
